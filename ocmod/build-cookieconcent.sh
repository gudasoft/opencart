...
# Build script for cookieconsent OCMOD extension
# This script creates a new zip file from the cookieconsent.ocmod directory

set -e  # Exit on error

EXTENSION_DIR="cookieconsent.ocmod"
ZIP_FILE="cookieconsent.ocmod.zip"
